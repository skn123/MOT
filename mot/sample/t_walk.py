...
class ThoughtfulWalk(AbstractSampler):
    ...
    def _get_mcmc_method_kernel_data(self):
        return Struct({
            'x1_position': Array(self._x1, 'mot_float_type', mode='rw', warn_extra_copy=True),
            'x1_log_likelihood': Array(self._x1_log_likelihood, 'mot_float_type', mode='rw', warn_extra_copy=True),
            'x1_log_prior': Array(self._x1_log_prior, 'mot_float_type', mode='rw', warn_extra_copy=True),
